...
class Database
{
    ...
    function input_buku($judul, $id_penulis, $id_kategori, $jumlah_hlm, $tahun_terbit, $tgl_masuk, $sinopsis, $isbn, $lokasi, $nama_file, $cover)
    {
        ...
        {
            $sql = "INSERT INTO buku (id_buku, judul, id_penulis, id_kategori, jumlah_hlm, tahun_terbit, tgl_masuk, sinopsis, isbn, lokasi) VALUES ('','$judul','$id_penulis','$id_kategori', '$jumlah_hlm', '$tahun_terbit', '$tgl_masuk', '$sinopsis', '$isbn', '$lokasi')";
            ...
            echo "Gagal Upload File Bukan PDF / Harap Upload Cover <a href='admin/list_buku.php'> Kembali </a>";
        }
    }
    ...
    function update_buku($id_buku, $judul, $id_penulis, $id_kategori, $jumlah_hlm, $tahun_terbit, $sinopsis, $isbn, $lokasi, $cover)
    {
        //pengecekan tipe harus pdf
        $tipe_file_cover = $_FILES['cover']['type']; //mendapatkan mime type
        if ($tipe_file_cover == "image/jpeg" || $tipe_file_cover == "image/png") //mengecek apakah file tersebut pdf atau bukan
        {
            $sql = "UPDATE buku SET judul='$judul', id_penulis='$id_penulis', id_kategori='$id_kategori', jumlah_hlm='$jumlah_hlm', tahun_terbit='$tahun_terbit',  sinopsis='$sinopsis',  isbn='$isbn',  lokasi='$lokasi' WHERE id_buku='$id_buku'";
            mysqli_query($this->con, $sql); //simpan data dahulu untuk mendapatkan id_buku
