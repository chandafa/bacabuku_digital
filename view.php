    ...
    <main>
        ...
        <div class="album py-4 bg-light">
            <div class="container">
                ...
                <hr>
                <embed class="animate__animated animate__fadeInUp" src="file/buku/<?php echo $data['nama_file']; ?>"
                    type="application/pdf" width="100%" height="1080px">
