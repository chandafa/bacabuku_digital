                ...
                <table class="table table-hover mt-5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a
                                    href="../admin/edit_penulis.php?id_penulis=<?php echo $data['id_penulis']; ?>&aksi=edit_penulis">
                                    <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                </a>
                                <a
                                    href="../proses.php?id_penulis=<?php echo $data['id_penulis']; ?>&aksi=hapus_penulis">
