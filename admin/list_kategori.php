                ...
                <table class="table table-hover mt-5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a
                                    href="../admin/edit_kategori.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=edit_kategori">
                                    <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                </a>
                                <a
                                    href="../proses.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=hapus_kategori">
