...
// Ambil data buku berdasarkan id_buku yang dikirim melalui parameter GET
$id_buku = $_GET['id_buku'];
$data_buku = $db->edit_buku($id_buku);
?>
                    ...
                    <?php foreach ($data_buku as $data) : ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_penulis" class="form-control" id="penulis">
                                <?php while ($d = mysqli_fetch_array($penulis)) : ?>
                                    <?php $selected = ($data['id_penulis'] == $d['id_penulis']) ? 'selected' : ''; ?>
                                    <option value="<?php echo $d['id_penulis']; ?>" <?php echo $selected; ?>>
                                        <?php echo $d['penulis']; ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="id_kategori" class="form-control" id="kategori">
                                <?php while ($d = mysqli_fetch_array($kategori)) : ?>
                                    <?php $selected = ($data['id_kategori'] == $d['id_kategori']) ? 'selected' : ''; ?>
                                    <option value="<?php echo $d['id_kategori']; ?>" <?php echo $selected; ?>>
                                        <?php echo $d['kategori']; ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="sinopsis" placeholder="Sinopsis" class="form-control" id="sinopsis" rows="10" minlength="20" required><?php echo $data['sinopsis']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="isbn" class="form-label">ISBN</label>
                            <input type="text" name="isbn" placeholder="ISBN" class="form-control" id="isbn" value="<?php echo $data['isbn']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi Buku</label>
                            <input type="text" name="lokasi" placeholder="Lokasi Buku" class="form-control" id="lokasi" value="<?php echo $data['lokasi']; ?>">
                        </div>
                        ...
                        <div class="my-4">
                            ...
                            <a href="../admin/list_buku.php" class="btn btn-secondary">Batal</a>
                        </div>
                    <?php endforeach; ?>
                </form>
            </div>
